...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/image/logo-sudahonline.png')}}" type="image/png" sizes="16x16">
    <!-- Bootstrap CSS CDN -->
...
<body>
    <div class="preloader" id="preloader">
        <div class="loading">
          <img src="{{ asset('assets/image/preloaderadm3.gif') }}" width="80" alt="preloader">
          <p style="font-weight:900;line-height:2;color:#336699;margin-left: -10%;">Harap Tunggu</p>
        </div>
    </div>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="z-index: 1.5;">
                <div class="container-fluid">
                    <a class="navbar-brand nav-center ">                    
                        <img src="{{ asset('assets/image/logo-sudahonline.png') }}" class="p-0 m-0 d-inline-block align-top" alt="logo-sudahonline" loading="lazy">
                    </a>
                </div>
