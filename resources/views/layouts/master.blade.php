...
<head>
    ...
    <title>Admin Clients @yield('title')</title>
    <!-- Favicon-->
    <link rel="icon" href="{{ asset('assets/image/logo-sudahonline.png')}}" type="image/x-icon">
...
<body class="theme-cyan">
    ...
    <!-- #END# Search Bar -->
    <!-- Top Bar -->
    <nav class="navbar" style="background: -webkit-linear-gradient(right, #2dbd6e, #a6f77b);">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="javascript:void(0);" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false"></a>
                <a href="javascript:void(0);" class="bars"></a>
                <!-- <a class="navbar-brand" href="#">ADMIN CLIENT</a> -->
                <img src="{{ asset('assets/image/logo-sudahonline.png') }}" class="p-0 m-0 d-inline-block align-top" alt="logo-sudahonline" loading="lazy" width="150" height="50">
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="{{request()->routeIs('clients.index') ? 'active' : '' }}">
                        ...
                        <ul class="ml-menu">
                            <li class="{{request()->routeIs('clients.index') ? 'active' : '' }}">
                                <a href="{{route('clients.index')}}">List Client</a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2020 <a href="javascript:void(0);"> SudahOnline.com</a>
                </div>
